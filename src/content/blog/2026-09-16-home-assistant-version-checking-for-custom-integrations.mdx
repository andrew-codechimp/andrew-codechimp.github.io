...
In practice, I recommend putting the `DOMAIN` and `MIN_HA_VERSION` constants in a separate `const.py` file within your integration and importing them into your `__init__.py`. This keeps your configuration centralised and makes it easier to update the minimum Home Assistant version in the future.
